...
export const metadata: Metadata = {
  ...
  description:
    "Shree International Packers and Movers Jaipur offers reliable household shifting, office relocation, packing and moving services. Call 9001189176 for safe and fast shifting.",
  keywords: [
